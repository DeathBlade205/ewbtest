...
export default function References() {
  const refs = [
    ...
    'Australian Renewable Energy Agency. (2025). Empowering First Nations communities with ARENA backed microgrids. https://arena.gov.au/news/empowering-first-nations-communities-with-arena-backed-microgrids/',
    ...
    'Engineers Without Borders Australia. (2025d). Design area 3: Energy. EWB Challenge. https://ewbchallenge.org/challenge/port-stewart-lama-lama/design-area-3-energy/',
    'Engineers Without Borders Australia. (2025e). About tropical north Queensland. EWB Challenge. https://ewbchallenge.org/challenge/port-stewart-lama-lama/about-tropical-north-queensland/',
