...
export default function Background() {
  return (
    <div>
      <SectionHero num="02" title="Background" subtitle="Energy access, environmental challenges, significance to the Lama Lama community, and limitations of existing solutions." />
