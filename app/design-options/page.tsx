...
export default function DesignOptions() {
  return (
    <div>
      <SectionHero num="03" title="Design Solution Options" subtitle="Three distinct system architectures evaluated against the needs of Lama Lama Country." />
      <div className="px-8 md:px-14 py-12 max-w-3xl">
        <div className="prose">
          ...
          <ScrollReveal delay={0.06}>
            <h3>4.1 Design Option A: Centralised Ground-Mounted Solar Farm with Shared Battery</h3>
          ...
          <ScrollReveal delay={0.08}>
            <h3>4.2 Design Option B: Distributed Rooftop Solar with Shared Battery and Diesel Fallback <span style={{ fontWeight: 400, fontSize: '0.85em' }}>(Proposed Solution)</span></h3>
          ...
          <ScrollReveal delay={0.1}>
            <h3>4.3 Design Option C: Fully Standalone Per-Building Solar and Battery with No Diesel</h3>
