...
export default function GroupDeclaration() {
  const members = [
    { name: 'Luc LeMoenic',    contribution: 'Completed sections relating to implementation planning, report editing, and consistency checks across the website and written report.' },
        ...
        <div className="prose">
          ...
          <ScrollReveal delay={0.06}>
            <p className="text-sm" style={{ color: 'var(--ink-muted)' }}>
              The following table declares each group member's individual contribution to this project. All members confirm that the work submitted is their own, that any use of AI tools has been disclosed in Appendix 3, and that all sources are cited in accordance with APA 7th edition referencing guidelines.
            </p>
          </ScrollReveal>
