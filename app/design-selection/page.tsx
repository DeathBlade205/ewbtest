      ...
      <div className="px-8 md:px-14 py-12 max-w-3xl">
        <div className="prose">
          ...
          <ScrollReveal delay={0.08}>
            <p>The Centralised Ground-Mount scores 1 on Desirability because ground-mounting requires vegetation clearance that cannot be reconciled with the community's custodial obligations to Country, and 1 on Competency because concentrating the entire system at a single location creates an unmanageable point of failure. The Per-Building Standalone scores 1 on Desirability because the absence of any shared fallback means an extended wet season cloud-cover event risks complete loss of safety-critical services at one or more buildings with no reserve to draw on, and 2 on Cost because per-building battery sizing to meet three-day autonomy requirements drives capital outlay well beyond what is realistic without grants (ARENA, 2023). The Distributed Rooftop option scores 5 on both Viability and Competency: rooftop distribution localises faults, the diesel fallback guarantees wet season continuity, and the Bushlight-proven training model confirms local maintainability (Independent Australia, 2025). With a weighted score of 72 against 40 and 36, the Distributed Rooftop with Shared Battery and Diesel Fallback is selected as the only option satisfying all five criteria simultaneously.</p>
          </ScrollReveal>
        </div>
      </div>
    </div>
