...
const NAV = [
  ...
  { href: '/background',           label: 'Background',            num: '01',  group: 'Report' },
  { href: '/problem',              label: 'Problem Description',   num: '02',  group: 'Report' },
  { href: '/design-options',       label: 'Design Options',        num: '03',  group: 'Report' },
  { href: '/design-selection',     label: 'Design Selection',      num: '04',  group: 'Report' },
  { href: '/detailed-design',      label: 'Detailed Design',       num: '05',  group: 'Report' },
  { href: '/prototyping',          label: 'Prototyping',           num: '06',  group: 'Report' },
  { href: '/implementation',       label: 'Implementation',        num: '07',  group: 'Report' },
  { href: '/cost-analysis',        label: 'Cost Analysis',         num: '08',  group: 'Report' },
  { href: '/other-considerations', label: 'Other Considerations',  num: '09',  group: 'Report' },
  { href: '/recommendations',      label: 'Recommendations',       num: '10',  group: 'Report' },
  { href: '/references',           label: 'References',            num: null,  group: 'End Matter' },
  { href: '/appendices',           label: 'Appendices',            num: null,  group: 'End Matter' },
]
